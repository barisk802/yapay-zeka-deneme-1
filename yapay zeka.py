...
if submit_button and soru:
    ...
    if "merhaba" in msg or "selam" in msg or "naber" in msg:
        ...
        cevap = "[şu anlık sana söyleyemiyorum ama linke tıklayarak gidebilirsin 🏆 Süper Lig Puan Durumu](https://www.tff.org/default.aspx?pageID=198)"
    elif "hava durumu" in msg:
        cevap = "[şu anlık sana söyleyemiyorum ama linke tıklayarak gidebilirsin ☀️ İzmir Hava Durumu](https://www.mgm.gov.tr/tahmin/il-ve-ilceler.aspx?il=Izmir)"
